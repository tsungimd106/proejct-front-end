        ...
        return (<>
            <Row className="justify-content-end sign">
                <Col sm={ 8 }>
                    ...
                    <p><input type="text" placeholder="性別" id="sex" /></p>
                    <p><input type="text" placeholder="年齡" id="age" /></p>
                    <p><input type="text" placeholder="名稱" id="name"/></p>
                    <Button variant="danger" onClick={ this.send }>繼續</Button>
                    <p>或</p>
                    <Button variant="success" >以LINE帳號繼續</Button>
                </Col>
            </Row>
            <ModalBase
